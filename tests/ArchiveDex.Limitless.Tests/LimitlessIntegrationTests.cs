...
namespace ArchiveDex.Limitless.Tests
{
    ...
    public class LimitlessIntegrationTests
    {
        ...
        public async Task GetSets_En_ReturnsRealSets()
        {
            ...
            List<LimitlessSet> sets = await client.GetSetsAsync(LimitlessLanguage.En);

            Assert.NotEmpty(sets);
            Assert.Contains(sets, s => s.Code == "PRE");
            Assert.Contains(sets, s => s.Code == "JTG");

            LimitlessSet pre = sets.First(s => s.Code == "PRE");
        ...
        public async Task GetSets_Jp_ReturnsRealSets()
        {
            ...
            var client = new LimitlessClient(Http);
            List<LimitlessSet> sets = await client.GetSetsAsync(LimitlessLanguage.Jp);
        ...
        public async Task GetCards_PRE_ReturnsAllPrints()
        {
            ...
            var client = new LimitlessClient(Http);
            List<LimitlessCard> cards = await client.GetCardsAsync("PRE", LimitlessLanguage.En);
        ...
        public async Task GetCards_JP_Set_ReturnsCards()
        {
            ...
            var client = new LimitlessClient(Http);
            List<LimitlessCard> cards = await client.GetCardsAsync("SV8a", LimitlessLanguage.Jp);
        ...
        public async Task GetSets_Jp_WithTranslate_ReturnsTranslatedSets()
        {
            ...
            var client = new LimitlessClient(Http);
            List<LimitlessSet> sets = await client.GetSetsAsync(LimitlessLanguage.Jp, translate: "en");
        ...
        public async Task GetCards_Jp_WithTranslate_ReturnsCards()
        {
            ...
            var client = new LimitlessClient(Http);
            List<LimitlessCard> cards = await client.GetCardsAsync("SV10", LimitlessLanguage.Jp, translate: "en");
