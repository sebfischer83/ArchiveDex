...
// src/app/app.ts
function App_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 10);
    \u0275\u0275listener("click", function App_Conditional_12_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.signOut());
    });
    \u0275\u0275element(1, "tui-icon", 11);
    \u0275\u0275text(2, " Abmelden ");
    \u0275\u0275elementEnd();
  }
}
var App = class _App {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _App, selectors: [["app-root"]], decls: 15, vars: 1, consts: [[1, "app-shell"], ["aria-label", "Main navigation", 1, "sidebar"], ["routerLink", "/", 1, "brand"], ["tuiTitle", ""], ["tuiButton", "", "appearance", "flat", "routerLink", "/capture", "routerLinkActive", "tui-active", 1, "nav-link"], ["icon", "@tui.camera"], ["tuiButton", "", "appearance", "flat", "routerLink", "/sets", "routerLinkActive", "tui-active", 1, "nav-link"], ["icon", "@tui.layout-grid"], ["tuiButton", "", "appearance", "flat", "type", "button", 1, "nav-link", "sign-out"], [1, "content"], ["tuiButton", "", "appearance", "flat", "type", "button", 1, "nav-link", "sign-out", 3, "click"], ["icon", "@tui.log-out"]], template: function App_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "tui-root")(1, "div", 0)(2, "nav", 1)(3, "a", 2)(4, "span", 3);
        \u0275\u0275text(5, "ArchiveDex");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(6, "a", 4);
        \u0275\u0275element(7, "tui-icon", 5);
        \u0275\u0275text(8, " Erfassen ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(9, "a", 6);
        \u0275\u0275element(10, "tui-icon", 7);
        \u0275\u0275text(11, " Sammlung ");
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(12, App_Conditional_12_Template, 3, 0, "button", 8);
        \u0275\u0275elementEnd();
      ...
      if (rf & 2) {
        \u0275\u0275advance(12);
        \u0275\u0275conditional(ctx.session.state().isAuthenticated ? 12 : -1);
      }
    }, dependencies: [RouterOutlet, RouterModule, RouterLink, RouterLinkActive, CommonModule, TuiRoot, TuiButton, TuiIcon, TuiTitle], styles: ["\n.app-shell[_ngcontent-%COMP%] {\n  display: flex;\n  min-height: 100vh;\n}\n.sidebar[_ngcontent-%COMP%] {\n  width: 200px;\n  background: var(--tui-background-base-alt);\n  padding: 1rem;\n  display: flex;\n  flex-direction: column;\n  gap: 0.35rem;\n}\n.brand[_ngcontent-%COMP%] {\n  text-decoration: none;\n  color: var(--tui-text-primary);\n  margin-bottom: 1rem;\n}\n.nav-link[_ngcontent-%COMP%] {\n  justify-content: flex-start;\n}\n.nav-link.tui-active[_ngcontent-%COMP%] {\n  background: var(--tui-background-neutral-1);\n  color: var(--tui-text-primary);\n}\n.sign-out[_ngcontent-%COMP%] {\n  margin-top: auto;\n}\n.content[_ngcontent-%COMP%] {\n  flex: 1;\n  padding: 2rem;\n}\n@media (max-width: 640px) {\n  .app-shell[_ngcontent-%COMP%] {\n    flex-direction: column;\n  }\n  .sidebar[_ngcontent-%COMP%] {\n    width: 100%;\n    flex-direction: row;\n    flex-wrap: wrap;\n  }\n  .sign-out[_ngcontent-%COMP%] {\n    margin-top: 0;\n  }\n  .content[_ngcontent-%COMP%] {\n    padding: 1rem;\n  }\n}\n/*# sourceMappingURL=app.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(App, [{
    type: Component,
    args: [{ selector: "app-root", standalone: true, imports: [RouterOutlet, RouterModule, CommonModule, TuiRoot, TuiButton, TuiIcon, TuiTitle], template: `
    <tui-root>
      <div class="app-shell">
  ...
  `, styles: ["/* angular:styles/component:css;6098652fc03a246750defb0ae98691d17b3bbf5799c5a7ab1dfd9089995f4be2;C:/Development/ArchiveDex/src/ArchiveDex.Server/ClientApp/src/app/app.ts */\n.app-shell {\n  display: flex;\n  min-height: 100vh;\n}\n.sidebar {\n  width: 200px;\n  background: var(--tui-background-base-alt);\n  padding: 1rem;\n  display: flex;\n  flex-direction: column;\n  gap: 0.35rem;\n}\n.brand {\n  text-decoration: none;\n  color: var(--tui-text-primary);\n  margin-bottom: 1rem;\n}\n.nav-link {\n  justify-content: flex-start;\n}\n.nav-link.tui-active {\n  background: var(--tui-background-neutral-1);\n  color: var(--tui-text-primary);\n}\n.sign-out {\n  margin-top: auto;\n}\n.content {\n  flex: 1;\n  padding: 2rem;\n}\n@media (max-width: 640px) {\n  .app-shell {\n    flex-direction: column;\n  }\n  .sidebar {\n    width: 100%;\n    flex-direction: row;\n    flex-wrap: wrap;\n  }\n  .sign-out {\n    margin-top: 0;\n  }\n  .content {\n    padding: 1rem;\n  }\n}\n/*# sourceMappingURL=app.css.map */\n"] }]
  }], null, null);
})();
(() => {
...
var routes = [
  { path: "", redirectTo: "/capture", pathMatch: "full" },
  {
    ...
    loadComponent: () => import("./chunk-6NIN4V3C.js").then((m) => m.CaptureUploadComponent)
  },
  {
    path: "capture/:captureId",
    canActivate: [authGuard],
    loadComponent: () => import("./chunk-PDV32CA5.js").then((m) => m.CaptureReviewComponent)
  },
  {
    path: "sets",
    canActivate: [authGuard],
    loadComponent: () => import("./chunk-63QAY2HU.js").then((m) => m.SetOverviewComponent)
  },
  {
    path: "sets/:setId/cards",
    canActivate: [authGuard],
    loadComponent: () => import("./chunk-XVIVL4ER.js").then((m) => m.CardListComponent)
  },
  {
    path: "cards/:cardId",
    canActivate: [authGuard],
    loadComponent: () => import("./chunk-QES6PTHG.js").then((m) => m.CardDetailComponent)
  },
  {
    path: "sign-in",
    loadComponent: () => import("./chunk-W47XKI4C.js").then((m) => m.SignInComponent)
  },
