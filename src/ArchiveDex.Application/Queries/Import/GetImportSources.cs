...
{
    public static ImportSourcesResponse Handle(GetImportSources query, ITcgDataSourceRegistry sources)
    {
        return new ImportSourcesResponse(
            Sources: sources.Sources.ToArray(),
