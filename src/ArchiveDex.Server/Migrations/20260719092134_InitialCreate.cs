        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false),
                    ImageAssetId1 = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CaptureDrafts_ImageAssets_ImageAssetId1",
                        column: x => x.ImageAssetId1,
                        principalTable: "ImageAssets",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValuationAmount = table.Column<decimal>(type: "numeric", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CardSpecimens_ImageAssets_ImageAssetId1",
                        column: x => x.ImageAssetId1,
                        principalTable: "ImageAssets",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CaptureDrafts_ImageAssetId1",
                table: "CaptureDrafts",
                column: "ImageAssetId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CardRecords_OwnerId_SetEditionId_NumberSortKey",
                table: "CardRecords",
                columns: new[] { "OwnerId", "SetEditionId", "NumberSortKey" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CardSpecimens_ImageAssetId1",
                table: "CardSpecimens",
                column: "ImageAssetId1");

            migrationBuilder.CreateIndex(
                name: "IX_CardSpecimens_OwnerId_CardRecordId",
                table: "CardSpecimens",
                columns: new[] { "OwnerId", "CardRecordId" });
