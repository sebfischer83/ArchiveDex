...
@Component({ selector: 'app-empty-state', standalone: true, imports: [TranslatePipe], template: `<div class="state"><p>{{ message }}</p></div>`, styles: [`.state{text-align:center;padding:2rem;color:#888}`] })
