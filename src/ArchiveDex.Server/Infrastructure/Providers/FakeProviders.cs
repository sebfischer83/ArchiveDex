            ...
            byte[] imageBytes, AnalysisOptions options = default, CancellationToken ct = default)
        {
            return Task.FromResult(new AnalysisResult(
                ...
                new ImageObservations(
                    ...
                    true, 1, null),
                null, null,
                new AiAnalysisCost("Fake", "fixture", 1200, 180, 0, 0m, "USD", false,
                    "fixture"),
                new ValuationResult(
                    "AVAILABLE", 1500, "EUR", DateTime.UtcNow, DateTime.UtcNow,
                    "Fake market", "Fixture price", "LOW", true,
                    "Unverbindliche Schätzung.", ["https://example.com/market-price"])));
        }
    }
